...
public class EmployeeRestController {
    ...
    public List<EmployeeDocument> listEmployees() {
        return employeeService.getAllEmployees();
    }

    @PostMapping("/employees/save")
    public String saveEmployee(@Valid @RequestBody EmployeeDocument employee) {
        employeeService.saveEmployee(employee);
        return "TRUE";
    }

    @GetMapping("/employees/{id}")
    public EmployeeDocument editEmployeeForm(@PathVariable Long id) {
